let Phases = [
    {},
    {
        ...
        Miner: {
            ...
            parts: [ MOVE, WORK, WORK,CARRY,CARRY, WORK, WORK ] // 700
        },
    }, {
        // Build defenses
        Level: 3,
        ...
        Miner: {
            count: LOOK_SOURCES,
            minimumEnergyToSpawn: 700,
            parts: [ WORK, WORK, WORK, WORK, WORK, MOVE,CARRY,CARRY ,CARRY ] // 700
        },
    },
    {
        // Build defenses
    ...
    },
    {
        ...
        Harvester: {
            count: 4,
            minimumEnergyToSpawn: 250,
            parts: [WORK,CARRY,MOVE,MOVE,CARRY,CARRY,MOVE,CARRY,CARRY,WORK,CARRY,CARRY]
        },
        Upgrader: {
            count: 3,
            minimumEnergyToSpawn: 250,
            parts: [WORK,CARRY,MOVE,MOVE,CARRY,WORK,MOVE,WORK,CARRY,CARRY,CARRY,WORK,CARRY]
        },
        Builder: {
            count: 2,
            minimumEnergyToSpawn: 250,
            parts: [WORK,CARRY,MOVE,MOVE,CARRY,WORK,MOVE,WORK,CARRY,WORK,CARRY,CARRY,CARRY]
        },
        Settler: {
            shardwide: true,
            count: 1,
        ...
        Miner: {
            count: LOOK_SOURCES,
            minimumEnergyToSpawn: 700,
            parts: [ WORK, WORK, WORK, WORK, WORK, CARRY,CARRY,CARRY ,MOVE ] // 700
        },
    }
];
