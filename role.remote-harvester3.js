...
class roleRemoteHarvester3 extends CreepsBase {
    constructor(role = 'Remote-Harvester3') {
        super(role);
    }
    ...
    run (creep) {
       ...
       let prospect = new RoomPosition(39,11, 'E9N7');
...
module.exports = new roleRemoteHarvester3();